...
from rbtr_legacy.events import ToolCallOutput
from rbtr_legacy.llm.deps import AgentDeps
from rbtr_legacy.llm.tools.common import shell_toolset
from rbtr_legacy.shell_exec import run_shell, truncate_for_agent
