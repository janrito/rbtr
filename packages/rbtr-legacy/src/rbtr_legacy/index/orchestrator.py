...
from rbtr_legacy.git import FileEntry, list_files
from rbtr_legacy.index.chunks import chunk_plaintext
from rbtr_legacy.index.edges import infer_doc_edges, infer_import_edges, infer_test_edges
from rbtr_legacy.index.models import (
    Chunk,
    ChunkKind,
    Edge,
    EdgeKind,
...
def update_index(
    ...
    *,
    ...
    """
    from rbtr_legacy.git import changed_files
...
def _embed_missing(
    ...
    *,
    ...
    try:
        from rbtr_legacy.index.embeddings import (  # deferred: heavy native lib
            embed_texts,
            embedding_text,
        )
    except Exception:
