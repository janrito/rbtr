...
from rbtr_legacy.models import DiscussionEntry, Target
...
if TYPE_CHECKING:
    ...
    from rbtr_legacy.github.client import GitHubCtx
    from rbtr_legacy.index.store import IndexStore
    from rbtr_legacy.providers.types import BuiltinProvider
    from rbtr_legacy.skills.registry import SkillRegistry
...
class EngineState:
    ...
    def gh_ctx(self) -> GitHubCtx | None:
        ...
        if self.gh is None:
            return None
        from rbtr_legacy.github.client import GitHubCtx  # deferred: avoids PyGithub at import time
