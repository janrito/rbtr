...
via the `rbtr_legacy.languages` entry-point group override both.
...
from rbtr_legacy.plugins.hookspec import PROJECT_NAME, LanguageHookspec, LanguageRegistration
...
class LanguageManager:
    ...
    3. External plugins via `rbtr_legacy.languages` entry points.
    ...
    def __init__(self) -> None:
        ...
        self._pm.load_setuptools_entrypoints("rbtr_legacy.languages")
    ...
    def _register_builtins(self) -> None:
        ...
        from rbtr_legacy.plugins.bash import BashPlugin
        from rbtr_legacy.plugins.c import CPlugin
        from rbtr_legacy.plugins.cpp import CppPlugin
        from rbtr_legacy.plugins.defaults import DefaultsPlugin
        from rbtr_legacy.plugins.go import GoPlugin
        from rbtr_legacy.plugins.java import JavaPlugin
        from rbtr_legacy.plugins.javascript import JavaScriptPlugin
        from rbtr_legacy.plugins.python import PythonPlugin
        from rbtr_legacy.plugins.ruby import RubyPlugin
        from rbtr_legacy.plugins.rust import RustPlugin
...
def reset_manager() -> None:
    ...
    Example::
        ...
        from rbtr_legacy.plugins.manager import get_manager, reset_manager
