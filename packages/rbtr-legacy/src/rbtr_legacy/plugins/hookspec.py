...
.. code-block:: python
    ...
    from rbtr_legacy.plugins.hookspec import LanguageRegistration, hookimpl
...
Third-party packages register via setuptools entry points::
    ...
    [project.entry-points."rbtr_legacy.languages"]
...
from rbtr_legacy.index.models import Chunk, ImportMeta
...
class LanguageHookspec:
    ...
    `rbtr_legacy.languages` entry-point group (external).
