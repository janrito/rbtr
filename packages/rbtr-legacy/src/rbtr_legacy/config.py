...
class RenderedConfig(Config):
        ...
        return (
            TomlConfigSettingsSource(
                ...
                toml_file=_toml_file(
                    user_dir / "config-legacy.toml",
                    workspace.workspace_dir() / "config-legacy.toml",
                ),
                deep_merge=True,
            ),
            env_settings,
    ...
    def update(self, **kwargs: Any) -> None:
        ...
        user_config = Path(self.user_dir) / "config-legacy.toml"
        workspace_config = workspace.workspace_dir() / "config-legacy.toml"
