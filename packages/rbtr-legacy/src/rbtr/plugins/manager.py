...
from rbtr.plugins.hookspec import PROJECT_NAME, LanguageHookspec, LanguageRegistration
...
class LanguageManager:
    ...
    def _register_builtins(self) -> None:
        ...
        from rbtr.plugins.bash import BashPlugin
        from rbtr.plugins.c import CPlugin
        from rbtr.plugins.cpp import CppPlugin
        from rbtr.plugins.defaults import DefaultsPlugin
        from rbtr.plugins.go import GoPlugin
        from rbtr.plugins.java import JavaPlugin
        from rbtr.plugins.javascript import JavaScriptPlugin
        from rbtr.plugins.python import PythonPlugin
        from rbtr.plugins.ruby import RubyPlugin
        from rbtr.plugins.rust import RustPlugin
...
def reset_manager() -> None:
    ...
    Example::
        ...
        from rbtr.plugins.manager import get_manager, reset_manager
